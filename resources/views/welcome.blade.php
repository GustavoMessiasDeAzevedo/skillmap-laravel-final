...
<body class="bg-slate-950 h-screen flex items-center justify-center p-4 overflow-hidden relative">
    ...
    <div class="text-center max-w-md w-full p-8 bg-slate-900/40 backdrop-blur-xl border border-slate-800/80 rounded-2xl shadow-2xl shadow-black/80 relative z-10">
        ...
        <div class="flex flex-col space-y-3.5">
            <a href="#" class="w-full bg-indigo-600 text-white font-semibold py-3.5 rounded-xl hover:bg-indigo-500 active:scale-[0.99] transition-all shadow-lg shadow-indigo-600/30 text-center">
                Entrar no Sistema
            </a>

            <a href="{{ route('profissionais.create') }}" class="w-full bg-orange-500 text-white font-semibold py-3.5 rounded-xl hover:bg-orange-400 active:scale-[0.99] transition-all shadow-lg shadow-orange-500/20 text-center">
                Criar Minha Conta
            </a>
        </div>
